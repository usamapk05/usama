...
const skills = [
  ...
  { name: 'SQL', level: 85 },
  { name: 'IBM Maximo', level: 85 },
  { name: 'Python', level: 65 },
  { name: 'Cloud Fundamentals', level: 60 },
];

const languages = [
  { name: 'Arabic', level: 'Fluent', percentage: 90 },
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
              With over 2 years of experience in business analytics, I specialize in creating
              powerful data visualizations and solutions using Power BI and IBM Maximo. My passion
              lies in uncovering insights that drive business decisions and optimize operations.
            </p>
