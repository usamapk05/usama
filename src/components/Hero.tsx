          ...
          <div className="order-2 lg:order-1 text-center lg:text-left max-w-2xl">
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 text-lg">
                Transforming complex data into actionable insights. 2+ years of experience
                in Power BI development, data analytics, and IBM Maximo solutions.
              </p>
            </motion.div>
            ...
            >
              <a
                ...
                className="p-3 rounded-full bg-secondary hover:bg-accent/20 transition-colors duration-300"
              >
